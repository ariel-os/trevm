...
pub use ariel::wasm_bindings::udp_api::{self as gen_udp, Host, HostWithStore, HostUdpSocket};
    ...
    fn from(t: IpAddress) -> Self {
        match t {
            IpAddress::Ipv4(ipaddr) => {
                ...
                gen_udp::IpAddr::V4(
                    gen_udp::Ipv4Addr::from_octets(octs)
                )
            },
            // #[cfg(feature = "ipv6")]
...
impl From<UdpMetadata> for gen_udp::UdpMetadata {
    fn from(t: UdpMetadata) -> Self {
        ...
        Self {
            endpoint: gen_udp::Endpoint { addr: e_addr, port: e_port },
...
impl From<gen_udp::UdpMetadata> for UdpMetadata {
    fn from(t: gen_udp::UdpMetadata) -> Self {
        let gen_udp::UdpMetadata { endpoint, local_addr: _ } = t;
